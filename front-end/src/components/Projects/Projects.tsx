...
const meusProjetos: IProjectItem[] = [
  {
    ...
    imagem: "src/assets/TODO-list-react.png",
...

  {
    ...
    imagem: "src/assets/clima-tempo.png",
...

  {
    ...
    imagem: "src/assets/detona-ralph.png",
...

  {
    ...
    imagem: "src/assets/gerador-de-senha.png",
...

  {
    ...
    imagem: "src/assets/dragon-ball.png",
...

  {
    ...
    imagem: "src/assets/landing-page-receita.png",
...

  {
    ...
    imagem: "src/assets/verificador-idade.png",
...

  {
    ...
    imagem: "src/assets/group-agencia.png",
...

  {
    ...
    imagem: "src/assets/calculadora-churrasco.png",
    repositorio:
...

  {
    ...
    imagem: "src/assets/starbucks.png",
